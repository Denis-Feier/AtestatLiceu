...
$i = 1;
$q =  "SELECT CodRef FROM abonamente";

$res = mysql_query($q);
while($r = mysql_fetch_array($res))
	$i++;

$q3 = "INSERT INTO Abonamente VALUES(".$i.",".$_POST['N'].",".$_POST['NR'].",'".$_POST['DATA1']."','".$_POST['DATA2']."')";

mysql_query($q3);

echo'<font color = "black"><h3>S-a adaugat un nou abonament</h3></font>'
?>
		</div>
        </td>
       </tr>
