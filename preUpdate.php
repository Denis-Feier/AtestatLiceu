...
while($r = mysql_fetch_array($res))
	echo '<br><font color = "black" size = "2">Numele Abonatului:'.$r['Nume'].'</font> <font color = "black" size = "2"><br>Numele Revistei:'.$r['NumeRev'].' <br>Data1:'.$r['Data1'].' <br>Data2:'.$r['Data2'].' <br></font> '." <a href = 'infoUpdate.php?n=".$r['CodRef']."'>MODIFICA</a><br>"
